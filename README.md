...
> **Authors:**
[Weiqing Yan](https://qing20200222.github.io/), [Yuanyang Zhang](https://zhangyuanyang21.github.io/), Chenlei Lv, [Chang Tang*](https://tangchang.net/), Guanghui Yue, Liang Liao, Weisi Lin. 
...
The Synthetic3d, Prokaryotic, and MNIST-USPS datasets are placed in "data" folder. The others dataset could be downloaded from [cloud(data)](https://pan.baidu.com/s/1XNWW8UqTcPMkw9NpiKqvOQ).
